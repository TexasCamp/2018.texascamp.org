...
import withTaxonomy from '../../../shared/query/withTaxonomy';
import { cleanHtml } from '../../../shared/utils';
import withLogic from './logic';
import styles from './styles.css';

const ProposedSessionsPage = (props) => {
  const {
    sessions,
    resetAllFilters,
    changeTextFilter,
            ...
            <div className={styles.detail}>
              ...
              {sessions.length === 0 &&
                <div className={styles.teaserWrapper}>
                  ...
                  <p className={styles.body}>
                    <Link href="/submit-session" className={styles.button}>
                      <a>Submit Session</a>
                    </Link>
                  </p>
                </div>}
...
export default compose(withApollo({ ssr: true }), withSessions, withHappenings, withTaxonomy, withLogic)(
